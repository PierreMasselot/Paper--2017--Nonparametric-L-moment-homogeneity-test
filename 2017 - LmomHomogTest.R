...
# X : list. Each element of the list contains the data for one site. Each element is a matrix with one variable per column (including the univariate case). Note that this allows different record length for each site ;
...
# printInfo : print the informations of the test and simulations iterations ?
{
